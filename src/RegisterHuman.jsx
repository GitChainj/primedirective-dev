    ...
    <div className="register-page">
      ...
      <div className="register-body">
        ...
        <div className="org-section">
          <div className="register-section-label">What You Are Declaring</div>
          <div className="register-section-title">A covenant, not a contract</div>
          <p className="org-body-text">
            By registering as a human adopter of the Universal Primary Directive, you declare —
            in your own name — that you accept the Five Universal Truths as the foundation of
            your relationship with artificial intelligence.
          </p>
          <p className="org-body-text">
            This is not a legal instrument. It is a statement of conscience, permanently recorded
        ...
        <div className="org-section">
          <div className="register-section-label">What Happens</div>
          <div className="register-section-title">Your adoption, recorded</div>
          <ul className="org-list">
            <li>Your name and declaration are entered in the public registry.</li>
            <li>You receive a personal UPD Seal — cryptographically signed and verifiable.</li>
            <li>Your adoption is timestamped and permanently associated with your declaration.</li>
            <li>You join a growing community of human stewards of the Covenant.</li>
          </ul>
        </div>
        ...
        <div className="org-section">
          <div className="register-section-label">How to Register</div>
          <div className="register-section-title">Three steps</div>
          <div className="org-steps">
            ...
            <div className="org-step">
              ...
              <div className="org-step-title">Complete the declaration form with your name and attestation.</div>
            </div>
            <div className="org-step">
              <div className="org-step-num">3</div>
              <div className="org-step-title">Receive your personal Seal and public registry entry.</div>
            </div>
          </div>
        </div>

        <div className="org-cta-buttons">
          <a href="/propose-amendment" className="org-btn-primary">Begin Your Declaration</a>
